                ...
                <div className="bg-white rounded-2xl shadow-2xl px-6 sm:px-8 py-8 w-full max-w-md">
                    {!registrationSuccess ? (
                        ...
                        <div className="text-center py-6">
                            <FaPaperPlane className="text-6xl text-blue-600 mx-auto mb-6 animate-bounce" />
                            ...
                            <div className="space-y-4">
                                <Link
                                    to="/"
                                    className="block w-full bg-blue-600 text-white font-bold py-3 rounded-md hover:bg-black transition-colors duration-300"
                                >
                                    Go to Login
                                </Link>
